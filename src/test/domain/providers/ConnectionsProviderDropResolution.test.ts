...
import type { DroppedMessage } from '../../../providers/dragDropMessageParser';
import type { Queue } from '../../../models/Queue';
import type { QueueMessage as QueueMessageData } from '../../../providers/QueueMessagesPanel';
import {
    mapMoveMessageToDomain,
    selectDropMessages,
} from '../../../providers/connectionsProviderDropResolution';
